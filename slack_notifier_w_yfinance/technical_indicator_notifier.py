'''
# Technical Indicator Notifier

Obtain the technical status of different stock symbols. Similar functionality
as the overall market tracker, but runs through different levels of granularity 
